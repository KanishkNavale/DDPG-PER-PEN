...
class Critic(tf.keras.Model):
    ...
    def __init__(self, density=32, name='critic'):
...
class Actor(tf.keras.Model):
    ...
    def __init__(self, n_actions, density=32, name='actor'):
...
class Agent:
    def __init__(self, env, datapath, n_games, alpha=0.001,
                 beta=0.002, gamma=0.99, tau=0.005, batch_size=64,
    ...
    def update_noisy_actor(self):
        ...
        for weight in self.actor.weights:
            ...
            weights.append(tf.add(weight, noise))
    ...
    def optimize(self):
        ...
        with tf.GradientTape() as tape:
            ...
            critic_loss = tf.keras.losses.mse(
                weighted_TD_errors, zero_tensor)
